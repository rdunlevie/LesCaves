...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { varietal_id: @wine.varietal_id, vineyard_id: @wine.vineyard_id, wine_id: @wine.wine_id, year: @wine.year } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { varietal_id: @wine.varietal_id, vineyard_id: @wine.vineyard_id, wine_id: @wine.wine_id, year: @wine.year } }
